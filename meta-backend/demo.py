# my_tuple = ('Hello', 'Hello', 1, True, 40.22)
# print(my_tuple.count(40.22))
...
# total_bill = round(sum_of(coffe=2.99, beer=3.55, water=2.99), 2)
# print(total_bill)
...
def display_menu():
    ...
    for selection in menu:
        print(f"{selection}. {menu[selection]['name']: <9} | {
